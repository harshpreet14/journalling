    ...
    <div className='w-full h-[80px] bg-white border-b'>
        ...
        <img src={logo} className="h-[78px] w-[90px]" />
            ...
            <div className='hidden md:flex'>
                ...
                <button className='px-8 py-3 rounded-md bg-[#FFC000] text-white font-bold'>Sign Up</button>
            </div>
        ...
        <div className={toggle?'absolute z-10 p-4  bg-white w-full px-8 md:hidden border-b':'hidden'}>
            <ul>
                    ...
                    <div className='flex flex-col my-4 gap-4'>
                        <button className='border border-[#FFC000] flex justify-center items-center  bg-transparent 
                        rounded-md px-6 gap-2 py-4'>
                         <img src={lock} />
                         Login
                        </button>
                        <button className='px-8 py-5 rounded-md bg-[#FFC000] text-white font-bold'>Sign Up </button>
                    </div>
            </ul>
        </div>
